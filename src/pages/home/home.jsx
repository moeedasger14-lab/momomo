        ...
        >
          ...
          >
            ...
            <Text style={{ marginLeft: "5px" }} strong>
              We are here to help you with your web development needs.and other
              subjects you want to learn like Math,Science,Boilogy and you want
              to learn any language we got your back . Here you can learn your
              subjects easily with the help of expert tutors . So what are you
              waiting for ? Lets gets started!
            </Text>
      ...
      children: (
        ...
        >
          ...
          <p style={{ fontSize: "16px", color: "#555" }}>
            We are a passionate team of educators and technologists committed to
            making learning accessible, personalized, and effective for every
            student.
          </p>
          ...
          <p style={{ fontSize: "16px", color: "#555" }}>
            Starting as a small group of tutors helping local students, we have
            grown into a platform that connects learners with expert guidance
            worldwide.
          </p>
          ...
          <p style={{ fontSize: "16px", color: "#555" }}>
            Student success is our top priority. We focus on clear explanations,
            adaptive practice, and supportive mentorship to ensure every learner
            thrives.
          </p>
          ...
          <p style={{ fontSize: "16px", color: "#555" }}>
            We offer one-on-one tutoring, group sessions, exam preparation, and
            interactive online resources tailored to each student’s needs.
          </p>
          ...
          <p style={{ fontSize: "16px", color: "#555" }}>
            Our platform thrives on collaboration between students, tutors, and
            parents, creating a supportive learning environment.
          </p>
          <Divider
            titlePlacement="left"
      ...
      children: (
        ...
        <Content className="momo8">
          <div className="momo81">
            ...
            <Text strong>
              Decide your fee according to your budget. No hidden charges. Try a
              demo class before you buy.
            </Text>
            <Divider titlePlacement="left" >
          ...
          <div className="momo82">
            ...
            <div className="bte">
              <div className="btnns">
                ...
                <Text strong>
                  With the freedom to choose the tuition time, you can learn at
                  any time & anywhere & get expert help when you need it.
                </Text>
              </div>
              <div className="btnne">
                <PoundCircleOutlined
        ...
        <Content className="momomo">
          ...
          <div className="mpm">
            <div className="bbb">
              ...
              <Text strong>
                {"   "} Not everyone can teach on Tutorbees.net now. There’s an
                Assessment, an in-person review of each tutor application, an
                automated onboarding course for tutors, and an in-person
                verification for teaching in English language for our tutors. We
                make your job of tutor-selection much easier for you!
              </Text>
              <Divider titlePlacement="left">
                <ArrowRightOutlined
                  className="btn"
              ...
              <Text strong>
                Tutors use tailored methods, they give one-on-one attention, and
                they are flexible with their schedules and pricing.
              </Text>
              <Divider titlePlacement="left">
                <ArrowRightOutlined
                  className="btn"
              ...
              <Text strong>
                Tutors will give you a demo class on your topic, if you share it
                with them beforehand. Ask your questions in the live class
                before you pay.
              </Text>
              <Divider titlePlacement="left">
                <ArrowRightOutlined
            ...
            <div className="bbbb"> <img className="brbb" src="./images/A clean and modern t.png" /></div>
          </div>
        </Content>
        <Footercomponent />
        </>
