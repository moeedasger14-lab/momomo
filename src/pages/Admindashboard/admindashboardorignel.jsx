import { Breadcrumb, Button, Card, Form, Input, Modal, Select, Table, Tabs } from "antd";
import React, { useState } from "react";
import { useNavigate, useParams, Link } from "react-router-dom";
import "./admindashboard.css";

import { AuditOutlined, EditOutlined, IdcardFilled, IdcardOutlined, SolutionOutlined } from "@ant-design/icons";
...
const [approvedTeachers, setApprovedTeachers] = useState(JSON.parse(localStorage.getItem("approvedTeachers")) || []);
const [approvedStudents, setApprovedStudents] = useState(JSON.parse(localStorage.getItem("approvedStudents")) || []);
const [approvedMessages, setApprovedMessages] = useState(JSON.parse(localStorage.getItem("approvedMessages")) || []);
...
const navigate = useNavigate();
  const columns = [
    ...
    { title: "Experience of Teaching", dataIndex: "experienceofteaching", key: "experienceofteaching" },
    { title: "Degree", dataIndex: "degree", key: "degree" },
    { title: "Country", dataIndex: "country", key: "country" },
    { title: "City", dataIndex: "city", key: "city" },
    { title: "university graduated from", dataIndex: "graduated", key: "graduated" },
    { title: "Student Id", dataIndex: "studentid", key: "studentid" },
    { title: "Certification Number", dataIndex: "certification", key: "certification" },
    {
      title: "Actions",
      key: "actions",
      render: (_, record) => (
   ...
   var column = [
    ...
    { title: "Certification Number", dataIndex: "certification", key: "certification" },
    {
      ...
      key: "action",
      render: (_, record) => (
        <Button onClick={() => DeleteTeachersbyIds(record.id)} type="dashed" danger>
          Ban
        </Button>
      ),
    },
   ...
   var colum = [
    ...
    { title: "In which school or university", dataIndex: "readss", key: "readss" },
    ...
    { title: "Student id", dataIndex: "ids", key: "ids" },
    {
      ...
      render: (_, record) => (
        <>
          <Button onClick={() => DeleteStudentsbyId(record.id)} type="dashed" danger style={{ marginRight: 8 }}>
            Reject
          </Button>
          <Button onClick={() => handleApproves(record)} type="dashed" style={{ borderColor: "green" }}>
            Approve
          </Button>
        </>
      ),
  ...
  var colm = [
    ...
    { title: "Student id", dataIndex: "ids", key: "ids" },
    {
      ...
      key: "actions",
      render: (_, record) => (
        <Button onClick={() => DeletestudentsbyIds(record.id)} type="dashed" danger>
          Ban
        </Button>
      ),
    },
...
const handleApprove = (record) => {
 ...
 const handleWhereDoYouLive = (field, value) => {
    ...
    if (nextRead === "School") {
      setCla(["Class 4","class 6","Class 7","Class 8","Class 9","class 10"]);
    }
    if (nextRead === "Collage") {
    ...
    {title:"Student id",dataIndex:"ids",key:"ids"},
    {
      ...
      render: (_, record) => (
        <>
          ...
          <Button onClick={()=>handleApproves(record)} variant="dashed" color="green">
            Approve
          </Button>
        </>
      ),
    ...
    {key:"1",
      ...
      children:(
       <Card title="Request by Students"
        >
           <Table scroll={{x:1400}} bordered style={{backgroundColor:"blue"}} dataSource={messageData.map((d,i)=> ({ ...d, key: d.key ?? d.id ?? i }))} columns={col} />
        </Card>
      )
    },
    {
      ...
      children:(
        ...
        >
           <Table scroll={{x:1400}} dataSource={approvedMessages.map((d,i)=> ({ ...d, key: d.key ?? d.id ?? i }))} columns={cols} />
        </Card>
      )
    }
  ]
  ...
  var tem = [
    {
      ...
      children: (
        <>
          ...
          >
            <Table dataSource={teachers.map((d,i)=> ({ ...d, key: d.key ?? d.id ?? i }))} scroll={true} bordered sticky columns={columns} />
          </Card>
          <Modal
          ...
          >
            <Form onFinish={handleTeachers} layout="vertical">
              ...
              label="Age"
              name="age"
              rules={[{required: true,message:"please select teacher age"}]}
              >
                <Select placeholder="please select teacher age">
                  ...
                  <Select.Option key="35" value="35">35</Select.Option>
                  <Select.Option key="38" value="38">38</Select.Option>
                  <Select.Option key="40" value="40">40</Select.Option>
                  <Select.Option key="45" value="45">45</Select.Option>
                  <Select.Option key="48" value="48">48</Select.Option>
                  <Select.Option key="50" value="50">50</Select.Option>
                  <Select.Option key="55" value="55">55</Select.Option>
                </Select>
              </Form.Item>
              <Form.Item
              label="Gender"
              name="gender"
              rules={[{required: true,message:"please select teacher gender"}]}
              >
                <Select placeholder="please select teacher gender">
                  <Select.Option key="Male" value="Male">Male</Select.Option>
                  <Select.Option key="Women" value="Women">Women</Select.Option>
              ...
              label="Expert"
              name="expert"
              rules={[{required: true,message:"please select teacher expertise"}]}
              >
                <Select mode="multiple" placeholder="please select teacher expertise">
                   <OptGroup
                  ...
                  >
                    ...
                    <Option key="Urdu" value="Urdu">Urdu</Option>
                  ...
                  <OptGroup  label={<span style={{ color: "yellow" }}>Language List</span>}>
                    <Option key="Englishs" value="Englishs">Englishs</Option>
                    <Option key="Urdus" value="Urdus">Urdus</Option>
                    ...
                    <Option key="Balochi" value="Balochi">Balochi</Option>
                    <Option key="Panjabi" value="Panjabi">Panjabi</Option>
                    <Option key="Chinese" value="Chinese">Chinese</Option>
                    <Option key="Russian" value="Russian">Russian</Option>
                  </OptGroup>
                  <OptGroup  label={<span style={{ color: "gold" }}>Coureses List</span>}>
                    ...
                    <Option key="Data Science" value="Data Science">Data Science</Option>
                    <Option key="DevOps" value="DevOps">DevOps</Option>
                    <Option key="Cloud Computing" value="Cloud Computing">Cloud Computing</Option>
                    <Option key="Cyber Security" value="Cyber Security">Cyber Security</Option>
                    <Option key="Machine Learning" value="Machine Learning">Machine Learning</Option>
                    <Option key="Artificial Intelligence" value="Artificial Intelligence">
                    ...
                    <Option key="Augmented Reality" value="Augmented Reality">Augmented Reality</Option>
                    <Option key="Virtual Reality" value="Virtual Reality">Virtual Reality</Option>
                    ...
                    <Option key="Node.js" value="Node.js">Node.js</Option>
                    <Option key="Express.js" value="Express.js">Express.js</Option>
              ...
              rules={[{required: true,message:"please select teacher experience of teaching"}]}
              >
                <Select placeholder="please select teacher experience of teaching">
                   <Option key="2 month" value="2 month">2 months</Option>
                  <Option key="5 month" value="5 month">5 months</Option>
                  <Option key="8 month" value="8 month">8 months</Option>
                  <Option key="12 months" value="12 months">12 months</Option>
                  <Option key="1 year" value="1 year">1 year</Option>
                  <Option key="2 years" value="2 years">2 years</Option>
                  <Option key="3 years" value="3 years">3 years</Option>
                  <Option key="4 years" value="4 years">4 years</Option>
                  <Option key="5 years" value="5 years">5 years</Option>
                  <Option key="6 years" value="6 years">6 years</Option>
                  <Option key="7 years" value="7 years">7 years</Option>
                  <Option key="8 years" value="8 years">8 years</Option>
                  <Option key="9 years" value="9 years">9 years</Option>
                  <Option key="10+ years" value="10+ years">10+ year</Option>
                </Select>
              </Form.Item>
              <Form.Item
              label="Degree"
              name="degree"
              rules={[{required: true,message:"please select teachers degree"}]}
              >
                <Select mode="multiple" placeholder="Please select teacher degree">
                  <Option key="B.A" value="B.A">B.A</Option>
                  <Option key="B.Sc" value="B.Sc">B.Sc</Option>
                  <Option key="B.Comp" value="B.Comp">B.Comp</Option>
                  <Option key="BBA" value="BBA">BBA</Option>
                  <Option key="BCS" value="BCS">BCS</Option>
                  <Option key="B.E" value="B.E">B.E</Option>
                  <Option key="B.Tech" value="B.Tech">B.Tech</Option>
                  <Option key="LL.B" value="LL.B">LL.B</Option>
                  <Option key="MBBS" value="MBBS">MBBS</Option>
                  <Option key="BDS" value="BDS">BDS</Option>
                  <Option key="Pharm.D" value="Pharm.D">Pharm.D</Option>
                  <Option key="B.Ed" value="B.Ed">B.Ed</Option>
                  <Option key="ADE" value="ADE">ADE</Option>
                  <Option key="M.A" value="M.A">M.A</Option>
                  <Option key="M.Sc" value="M.Sc">M.Sc</Option>
                  <Option key="M.Comp" value="M.Comp">M.Comp</Option>
                  <Option key="MBA" value="MBA">MBA</Option>
                  <Option key="MCS" value="MCS">MCS</Option>
                  <Option key="M.E" value="M.E">M.E</Option>
                  <Option key="LL.M" value="LL.M">LL.M</Option>
                  <Option key="M.Ed" value="M.Ed">M.Ed</Option>
                  <Option key="M.Phil" value="M.Phil">M.Phil</Option>
                  <Option key="PH.D" value="PH.D">Ph.D</Option>
                  <Option key="MD" value="MD">MD</Option>
                  <Option key="Pharm.D (advanced)" value="Pharm.D (advanced)">Pharm.D (advanced)</Option>
                </Select>
              </Form.Item>
              <Form.Item 
              label="Country"
              name="country"
              rules={[{required: true,message:"please select in which country teacher lives"}]}
               >
                <Select onChange={() => handleCountryChange(values)} placeholder="please select in country the teacher lives">
                    ...
                    <Option key="Maxico" value="Maxico">Maxico</Option>
                    ...
                    <Option key="Indonesia" value="Indonesia">Indonasia</Option>
                    <Option key="Ukrian" value="Ukrian">Ukrian</Option>
                    <Option key="Soudi arabia" value="Soudi arabia">Soudi arabia</Option>
                    <Option key="Malesia" value="Malesia">Malesia</Option>
              ...
              label="City"
              name="city"
              rules={[{required: true,message:"please select in which city does teacher live"}]}
              >
                <Select onChange={handleCityChange} placeholder="please select in which city does teacher live">
                 {cities.map((city) => (
              ...
              name="graduated"
              rules={[{required: true,message:"please select from which university have teacher graduated from"}]}
              >
              ...
              label="Student Id"
              name="studentid"
              rules={[{required:true,message:"please enter teacher student id"}]}
              >
              ...
              <Form.Item
               ...
               name="certification"
               rules={[{required: true,message:"please enter teacher certification number"}]}
              >
    ...
    },
    {
      ...
      children:(
         <Card
          ...
          >
            <Table dataSource={approvedTeachers.map((d,i)=> ({ ...d, key: d.key ?? d.id ?? i }))} scroll={true} bordered sticky columns={column} />
          </Card>
      )
    }
  ];
 ...
 var itms = [
    {
      ...
      children: (
        <>
          ...
          >
         <Table bordered dataSource={students.map((d,i)=> ({ ...d, key: d.key ?? d.id ?? i }))} columns={colum} />
          </Card>
          <Modal
          ...
          >
            <Form onFinish={handleStudent} layout="vertical">
              ...
              label="Age"
              name="age"
              rules={[{required: true,message:"please select student age"}]}
              >
                <Select placeholder="please select student age">
                  ...
                  <Select.Option key="11" value="11">11</Select.Option>
                  <Select.Option key="12" value="12">12</Select.Option>
                  <Select.Option key="13" value="13">13</Select.Option>
                  <Select.Option key="14" value="14">14</Select.Option>
                  <Select.Option key="15" value="15">15</Select.Option>
                  <Select.Option key="16" value="16">16</Select.Option>
                  <Select.Option key="17" value="17">17</Select.Option>
                  <Select.Option key="18" value="18">18</Select.Option>
                  <Select.Option key="19" value="19">19</Select.Option>
                  <Select.Option key="20" value="20">20</Select.Option>
                  <Select.Option key="21" value="21">21</Select.Option>
                  <Select.Option key="22" value="22">22</Select.Option>
                  <Select.Option key="23" value="23">23</Select.Option>
                  <Select.Option key="24" value="24">24</Select.Option>
                  <Select.Option key="25" value="25">25</Select.Option>
                  <Select.Option key="26" value="26">26</Select.Option>
                  <Select.Option key="27" value="27">27</Select.Option>
                  <Select.Option key="28" value="28">28</Select.Option>
                  <Select.Option key="29" value="29">29</Select.Option>
                  <Select.Option key="30" value="30">30</Select.Option>
                  <Select.Option key="31" value="31">31</Select.Option>
                  <Select.Option key="32" value="32">32</Select.Option>
                  <Select.Option key="33" value="33">33</Select.Option>
                  <Select.Option key="34" value="34">34</Select.Option>
                  <Select.Option key="35" value="35">35</Select.Option>
                </Select>
              </Form.Item>
              <Form.Item
              ...
              label="Country"
              name="country"
              rules={[{required: true,message:"please select in which country student lives"}]}
               >
                <Select onChange={handleCountryChange} placeholder="please select in country the student lives">
                      <Option key="Pakistan" value="Pakistan">Pakistan</Option>
                    <Option key="USA" value="USA">USA</Option>
                    <Option key="Germany" value="Germany">Germany</Option>
                    <Option key="UK" value="UK">UK</Option>
              ...
              label="City"
              name="city"
              rules={[{required: true,message:"please select in which city does student live"}]}
              >
                <Select  
 placeholder="please select in which city does student live"   onChange={(value) => handleWhereDoYouLive("live", value)}>
                 {cities.map((city) => (
                    <Option key={city} value={city}>
                      {city}
                    </Option>
               ...
               { required: true, message: "please select where you read" },
                            ...
                            >
                              ...
                              >
                                ...
                                <Option key="Collage" value="Collage">Collage</Option>
                              ...
                              <Form.Item
                                ...
                                rules={[
                                  {
                                    required: true,
                                    message: "please select in which school or university do you read",
                                  },
                                ]}
                              >
                                <Select style={{ width: "70%" }} placeholder="please select in which school or university do you read">
                                  {school.map((school) => (
                                           ...
                                           <Form.Item
                                                ...
                                                >
                                                  <Select
                                                   ...
                                                   style={{width:"70%"}} placeholder="please select in which class do you read in">
                                                       {cla.map((cla) => (
    ...
    },
    {
      ...
      children:(
         <Card
          ...
          >
         <Table bordered dataSource={approvedStudents.map((d,i)=> ({ ...d, key: d.key ?? d.id ?? i }))} columns={colm} />
          </Card>
      )
    },
  ];
  ...
  var item = [
    {
      ...
      children: (
        <Tabs
          ...
          tabBarStyle={{
            color: "grey",
            background:"linear-gradient(-45deg ,orange,red,lime,yellow,rgb(224, 115, 133),rgb(26, 165, 211),white)",
            borderRadius: "8px",
          }}
        />
      ),
    ...
    { key: "3", label: "Guest Request", children: (
      <Tabs 
      tabPlacement="start"
  ...
  var items = [
    ...
    },
    {
      ...
      children:(
        ...
        title="Active Users"
        >
          <img src="/images/active.jpg" style={{height:"500px",width:"100%"}} />
<Tabs 
centered
items={co}
type="card"
